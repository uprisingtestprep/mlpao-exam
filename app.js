/* MLPAO Exam Simulator — Application Logic */

const ACCESS_CODE  = "MLPAO9000";
const EXAM_SECONDS = 10800;
const PASSING_PCT  = 60;
const STORAGE_KEY  = "mlpao_exam_state_v1";
const SIM_Q_COUNT  = 200;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"professional_practice": "Professional Practice", "medical_terminology_basic_biology_anatomy_and_physiology": "Medical Terminology Basic Biology Anatomy and Physiology", "laboratory_mathematics_statistics_and_quality_management": "Laboratory Mathematics Statistics and Quality Management", "specimen_procurement_processing_and_data_collection": "Specimen Procurement Processing and Data Collection", "laboratory_safety": "Laboratory Safety", "laboratory_equipment_and_supplies": "Laboratory Equipment and Supplies", "histology_and_cytology": "Histology and Cytology", "clinical_microbiology": "Clinical Microbiology", "clinical_chemistry": "Clinical Chemistry", "clinical_hematology": "Clinical Hematology", "transfusion_medicine": "Transfusion Medicine", "electrocardiograms_and_holter_monitors": "Electrocardiograms and Holter Monitors"};  // maps domain key -> human-readable label for display
